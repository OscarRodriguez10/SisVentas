...
class ArticuloController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request)
        {
            ...
            ->join('proveedores as p','a.idproveedor','=','p.idproveedor','')
            
            ->select('a.idarticulo','a.nombre','a.codigo','c.nombre as categoria','a.preciocosto','a.precioventa','a.formula','a.bono','a.estado','p.nombre as proveedores')
            ->where('a.nombre','LIKE','%'.$query.'%')
            ->orwhere('a.codigo','LIKE','%'.$query.'%')
            ->orwhere('a.formula','LIKE','%'.$query.'%')
